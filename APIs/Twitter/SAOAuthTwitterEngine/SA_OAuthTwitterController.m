...
- (BOOL) webView: (UIWebView *) webView shouldStartLoadWithRequest: (NSURLRequest *) request navigationType: (UIWebViewNavigationType) navigationType {
	...
	//if ([urlString rangeOfString:@"http://www.wiley.com"].location == NSNotFound)
	if ([urlString rangeOfString:[Utils	getValueForVar:kTwitterUrlCallback]].location == NSNotFound)
	{
