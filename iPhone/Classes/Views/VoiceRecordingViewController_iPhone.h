...
@interface VoiceRecordingViewController_iPhone : UIViewController<UITextViewDelegate,UITableViewDelegate, AVAudioRecorderDelegate> {
	...
	VoiceNotesViewController_iPhone* _parentController;
