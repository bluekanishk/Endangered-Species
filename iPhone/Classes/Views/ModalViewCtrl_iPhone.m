...
- (void)viewWillAppear:(BOOL)animated
{
	...
	CustomWebView_iPhone* wvHTMLPage = [[CustomWebView_iPhone alloc] initWithFrame:CGRectMake(0, 44, 320, 436)];
	...
	switch(_contentType)
	{
		...
		case kContentTypeHelp:
			_navItem.title = @"Help";
			[wvHTMLPage loadClearBgHTMLString:[[AppDelegate_iPhone getDBAccess] GetHelpString]];
		...
		case kContentTypeInfo:
			...
			[wvHTMLPage loadClearBgHTMLString:[[AppDelegate_iPhone getDBAccess] GetInfoString]];
			_tableView.hidden = YES;
			_webView.hidden = YES;
			break;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
	...
	else if(_isRandomOption == YES)
	{
		...
		UISwitch *objSwitchRandom=[[[UISwitch alloc] initWithFrame:CGRectMake(200,17,100,25)] autorelease];
...
- (BOOL) handleShouldStartLoadWithWebView:(NSDictionary *)notification
{
	...
	vcHTMLDisplayer = [[HTMLDisplayController_iphone alloc] initWithNibName:@"HTMLDisplayController_iphone" bundle:nil];
